...
class Book:
    def __init__(self, title: str, description: str, language: str, authors: list[Author], genres: list[Genre],
                 year_of_publication: int, isbn: str):
        """
Book instance has the following information about it:
    ...
    def __str__(self) -> str:
        ...
        return f"{self.title} ({authors_str}) - {self.year_of_publication}, {genres_str}"

    def __repr__(self) -> str:
        return (f"Book({self.title}, {self.description}, {self.language}, {self.authors}, "
